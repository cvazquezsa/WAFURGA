...
[Fiscal.Sucursal.CuentaIVA]
Carpeta=Fiscal
Clave=Sucursal.CuentaIVA
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Fiscal.Sucursal.CuentaVenta]
Carpeta=Fiscal
Clave=Sucursal.CuentaVenta
Editar=S
ValidaNombre=S
3D=S
Tamano=30
...
[Fiscal.Sucursal.CuentaAlmacen]
Carpeta=Fiscal
Clave=Sucursal.CuentaAlmacen
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
...
[Fiscal.Sucursal.CuentaCosto]
Carpeta=Fiscal
Clave=Sucursal.CuentaCosto
Editar=S
LineaNueva=N
ValidaNombre=S
3D=S
...
Sucursal.FiscalZona=Sucursal.CuentaIVA
Sucursal.CuentaIVA=Sucursal.CuentaVenta
Sucursal.CuentaVenta=Sucursal.CuentaAlmacen
Sucursal.CuentaAlmacen=Sucursal.CuentaCosto
Sucursal.CuentaCosto=Sucursal.CuentaDevolucion
Sucursal.CuentaDevolucion=(Fin)

[Fiscal.Sucursal.CuentaDevolucion]
Carpeta=Fiscal
Clave=Sucursal.CuentaDevolucion
Editar=S
LineaNueva=S
ValidaNombre=S
3D=S
