...
namespace WebService2.ConsultaVentas
{
    /// <summary>
    ...
    public class ConsultaVentas : System.Web.Services.WebService
    {

        [WebMethod]
        public XmlDocument ConsultarVentas(string Empresa,string ClaveFabricante, string Fabricante, bool Recurrente)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "spWebServiceVentas";
